...
const divFunction = () =>{
    const input1 = divForm.firstNumDiv.value
    const input2 = divForm.secondNumDiv.value
    const divIt = parseInt(input1) / parseInt(input2)
    const divElement = document.createElement("h1")
    divElement.textContent =divIt
